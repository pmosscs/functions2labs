...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((num , index, array) => array[index].CP > 200);
...
// CODE HERE
const totalCost = orders.map((obj, index, array) => array[index].price * (1 + array[index].tax))
